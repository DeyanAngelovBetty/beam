 ...
 *
 * Figma: Beam MUI v9 → node 12743:68281. Deyan's ratified panel: Paper, 24px padding, 24px gutters,
 * items TOP-aligned, rows sized by their tallest member, booleans inline as peers.
 */
