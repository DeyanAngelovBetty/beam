...
import { TableFiltersLegacy } from './TableFiltersLegacy';
 ...
 */
const meta = {
  title: 'Components/TableFiltersLegacy',
  component: TableFiltersLegacy,
  parameters: { layout: 'padded' },
} satisfies Meta<typeof TableFiltersLegacy>;
