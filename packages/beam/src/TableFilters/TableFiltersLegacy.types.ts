...
/**
 * TableFiltersLegacy — the list-screen filter surface (grammar doc §1).
 *
...
/**
 * Advanced-representation config. Presence turns TableFiltersLegacy into the advanced panel: a [+] add-field
...
export interface TableFiltersLegacyProps {
