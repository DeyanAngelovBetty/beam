  ...
  return (
    <Box
      ...
      sx={{
        ...
        // Reduced-motion-safe entrance: rides the move-duration var, which the reduced-motion kill
        // switch zeroes → the bar lands instantly, no slide.
        animation: `${enter} var(--beam-motion-move-duration, 300ms) var(--beam-motion-move-easing, ease)`,
      }}
    >
